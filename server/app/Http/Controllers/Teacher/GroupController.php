...
class GroupController extends Controller
{
    ...
    public function info(Request $request, $groupId) {
        ...
        $group = Group::with(['subjects.teacherSubject.subjects','subjects.teacherSubject.teacher', 'students','schedules.subject.teacherSubject.teacher.auditorium'])->find($groupId);
